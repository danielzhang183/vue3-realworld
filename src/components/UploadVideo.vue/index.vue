...
import { createUploadVideo, refreshUploadVideo } from '@/apis/vod'
  ...
  setup(props, context) {
    ...
    const createUploader = () => {
      const uploader = new window.AliyunUpload.Vod({
        ...
        // 文件上传成功
        async onUploadSucceed(uploadInfo: any) {
        ...
        // 上传凭证超时
        async onUploadTokenExpired(uploadInfo: any) {
